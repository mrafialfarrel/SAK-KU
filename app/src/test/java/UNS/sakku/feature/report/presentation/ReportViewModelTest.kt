...
class ReportViewModelTest {
    ...
    fun `transaksi dikelompokkan dan dijumlahkan berdasarkan kategori dengan akurat`() = runTest {
        ...
        val mockTransactions = listOf(
            ...
            TransactionItem("2", "Kopi", 20000.0, false, "Konsumsi", "Dompet"),
            TransactionItem("3", "Bensin", 30000.0, false, "Transportasi", "Dompet"),
            TransactionItem("4", "Gaji Pokok", 5000000.0, true, "Gaji", "Bank"),
